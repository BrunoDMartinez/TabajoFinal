...
imgArrastrada.addEventListener("dragstart", (event) => {
    event.dataTransfer.setData("Text1", "./imagenes/Rompe1.png");
});
...
imgArrastrada1.addEventListener("dragstart", (event) => {
    event.dataTransfer.setData("Text2", "./imagenes/Rompe3.png");
});
...
imgArrastrada2.addEventListener("dragstart", (event) => {
    event.dataTransfer.setData("Text3", "./imagenes/rompe2.png");
});
